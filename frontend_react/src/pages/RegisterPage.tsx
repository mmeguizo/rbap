...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      // Note: Full registration requires a Google registration token
      // from the Google OAuth flow. For direct registration without Google,
      // use the dev flow or contact admin.
      setError(
        "Registration requires signing in with Google first. Please use 'Sign in with Google' to start.",
      );
    } catch (err: unknown) {
